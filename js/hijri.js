...
var HijriJS = {
	...
	gregorianToHijri : function gregorianToHijri(pYear, pMonth, pDay) {
		...
		// to display month names instead of numbers
		var monthNames = ['Muharram', 'Safar', 'Rabi\' al-awwal', 'Rabi\' al-thani', 'Jumada al-awwal', 'Jumada al-thani', 'Rajab', 'Sha\'aban', 'Ramadan', 'Shawwal', 'Dhu al-Qi\'dah', 'Dhu al-Hijjah'];
		...
		// console.log(monthNames[im]); //for debugging
		return new this.HDate(iy, monthNames[im-1], id);
	},
...
function initWork() {
	...
	// document.write(HijriJS.today().toString());
}
initWork();
